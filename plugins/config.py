...
class Config(object):
    ...
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "-1001806753811")
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://sidhu:20092001@fils.o0eeodh.mongodb.net/?retryWrites=true&w=majority")

    SESSION_NAME = os.environ.get("SESSION_NAME", "spmki")
    ...
    UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001806753811")
    
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "SPMKIBOT")
